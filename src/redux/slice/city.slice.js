...
import { fetchStates, insertState, updateState, deleteState } from '../../apis/master/state.api';
import { deleteCity, fetchCities, insertCity, updateCity } from '../../apis/master/city.api';
...
export { fetchCityRecords, updateCityRecord, insertCityRecord, deleteCityRecord, changeCityParameter };
