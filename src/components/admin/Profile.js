              ...
              <div className="flex justify-center py-4 lg:pt-4 pt-8">
                ...
                <div className="text-center ">
                  ...
                  <div className="mb-2 text-blueGray-600">
                    <i className="fas fa-briefcase mr-2 text-lg text-blueGray-400"></i>{userData.role.split("_").join(" ")}
                  </div>
                  <div className="mb-2 text-blueGray-600">
                    <i className="fas fa-university mr-2 text-lg text-blueGray-400"></i>{userData.email}
                  </div>
                </div>
              </div>
            </div>
