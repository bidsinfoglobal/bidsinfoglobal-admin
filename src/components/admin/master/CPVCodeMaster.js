...
import {
    ...
    deleteCPVRecord,
    changeCPVParameter,
} from '../../../redux/slice/cpvcode.slice';
...
export default function CPVCodeMaster() {
    ...
    useEffect(() => {
        ...
        fetchRecord({
            pageNo: CPVCode.pageNo,
            limit: CPVCode.limit,
            sortBy: CPVCode.sortBy,
            sortField: CPVCode.sortField || '_id',
            keywords: CPVCode.keywords,
        });
    }, []);
            ...
            render: (e, record) => (
                <div className="flex gap-2" key={record._id}>
                    <ManagerModel
                        key={record._id}
                        id={record._id}
                        submitHandler={handleCPVCodeSubmit}
                        _cpvcode={record}
                    />
                    <Button
                        title="Delete"
                    ...
                    <form onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <div className="form-group mb-6">
                            ...
                            <input
                                ...
                                defaultValue={_cpvcode?.description || ''}
                            />
                        </div>
                        <div>
                            <button
