...
import { FetchCMSByType, UpdateGrantsInfoCMS } from '../../../apis/cms.api';
...
export default function GrantInfoCMS() {
    ...
    const onSubmit = async (body) => {
        try {
            ...
            var response = await UpdateGrantsInfoCMS(body);
    ...
    useEffect(() => {
        // _id for update
        (async function() {
            var response = await FetchCMSByType('grants_info');
  ...
  return (
    <div className=''>
        <h1 className='mb-6 md:mb-12 text-xl md:text-2xl lg:text-3xl font-bold font-bold'>Grant Info</h1>
        <div className=''>
