...
export default function EprocurmentInfoCMS() {
  ...
  return (
    <div className=''>
        <h1 className='mb-6 md:mb-12 text-xl md:text-2xl lg:text-3xl font-bold font-bold'>Eprocurment Info</h1>
        <div className=''>
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className="form-group mb-6">
                <label className="font-bold">Drop Demo Title <span className='text-red-600'>*</span></label>
                <span className='text-red-600 md:ml-4'>{errors?.drop_demo_title?.message}</span>
                <input type="text" className={inputclass} name="drop_demo_title" {...register("drop_demo_title", { required: 'This field is required' })}
                    aria-describedby="drop_demo_title" placeholder="drop demo title" />
            </div>
            <div className="form-group mb-6">
                <label className="font-bold">Drop Demo Description <span className='text-red-600'>*</span></label>
                <span className='text-red-600 md:ml-4'>{errors?.drop_demo_description?.message}</span>
                <textarea type="text" className={inputclass} name="drop_demo_description" {...register("drop_demo_description", { required: 'This field is required' })}
                    aria-describedby="drop_demo_description" placeholder="drop demo description" />
            </div>
            <div>
