...
import { FetchCMSByType, UpdateServiceInfoCMS } from '../../../apis/cms.api';
...
export default function ServiceInfoCMS() {
    ...
    const onSubmit = async (body) => {
        try {
            ...
            var response = await UpdateServiceInfoCMS(body);
    ...
    useEffect(() => {
        // _id for update
        (async function() {
            var response = await FetchCMSByType('service_page');
  ...
  return (
    <div className=''>
        <h1 className='mb-6 md:mb-12 text-xl md:text-2xl lg:text-3xl font-bold font-bold'>Service Info</h1>
        <div className=''>
