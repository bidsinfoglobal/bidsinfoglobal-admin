...
import { FetchCMSByType, UpdateContractAwardInfoCMS } from '../../../apis/cms.api';
...
export default function ContractAwardInfoCMS() {
    ...
    const onSubmit = async (body) => {
        try {
            ...
            var response = await UpdateContractAwardInfoCMS(body);
    ...
    useEffect(() => {
        // _id for update
        (async function() {
            var response = await FetchCMSByType('contract_award_info');
  ...
  return (
    <div className=''>
        <h1 className='mb-6 md:mb-12 text-xl md:text-2xl lg:text-3xl font-bold font-bold'>Contract Info</h1>
        <div className=''>
