...
export default function Project() {
    ...
    const columns = [
        ...
        },
        {
            ...
            width: 150,
            sorter: (a, b) =>
                a.estimated_project_completion_date - b.estimated_project_completion_date,
        },
        {
            title: 'Big Ref No',
                  ...
                  render: (e, record) => (
                      <div className="flex gap-2" key={record._id}>
                          <ManagerModel
                              key={record._id}
                              id={record._id}
                              submitHandler={handleProjectSubmit}
                              _project={record}
                          />
                          <Button
                              title="Delete"
                        ...
                        <div className="grid md:grid-cols-2 lg:grid-cols-3 md:gap-3">
                            ...
                            <div className="form-group mb-6">
                                ...
                                <input
                                    ...
                                    defaultValue={_project?.project_name || ''}
                                />
                            </div>
                            <div className="form-group mb-6">
                                ...
                                <input
                                    ...
                                    aria-describedby="project_background"
                                    placeholder="project_background"
                                    defaultValue={_project?.project_background || ''}
                                />
                            </div>
                            <div className="form-group mb-6">
                                ...
                                <input
                                    ...
                                    defaultValue={_project?.project_location || ''}
                                />
                            </div>
                            <div className="form-group mb-6">
                                ...
                                <input
                                    ...
                                    aria-describedby="project_status"
                                    placeholder="project_status"
                                    defaultValue={_project?.project_status || ''}
                                />
                            </div>
                            <div className="form-group mb-6">
                                ...
                                <input
                                    type="Date"
                                    className={inputClass}
                                    name="project_publishing_date"
                                    {...register('project_publishing_date')}
                                    aria-describedby="project_publishing_date"
                                    placeholder="project_publishing_date"
                                    defaultValue={_project?.project_publishing_date || ''}
                                />
                            </div>
                            <div className="form-group mb-6">
                                <label className="font-bold">
                                ...
                                <input
                                    type="Date"
                                    className={inputClass}
                                    name="estimated_project_completion_date"
                                    {...register('estimated_project_completion_date')}
                                    aria-describedby="estimated_project_completion_date"
                                    placeholder="estimated_project_completion_date"
                                    defaultValue={
                                        _project?.estimated_project_completion_date || ''
                                    }
                                />
                            </div>
                        </div>
                        <div className="grid md:grid-cols-2 lg:grid-cols-3 md:gap-3">
                            <div className="form-group mb-6">
                                ...
                                <input
                                    ...
                                    defaultValue={_project?.big_ref_no || ''}
                                />
                            </div>
                            <div className="form-group mb-6">
                                ...
                                <input
                                    ...
                                    defaultValue={_project?.client_name || ''}
                                />
                            </div>
                            <div className="form-group mb-6">
                                ...
                                <input
                                    ...
                                    defaultValue={_project?.client_address || ''}
                                />
                            </div>
                            <div className="form-group mb-6">
