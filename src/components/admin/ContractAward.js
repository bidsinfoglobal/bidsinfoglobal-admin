...
export default function ContractAward() {
    ...
    function fetchRecord({ pageNo, limit, sortBy, sortField, keywords }) {
        dispatch(
            fetchContractAwardRecords({ pageNo, limit, sortBy, sortField, keywords }),
        );
    }
                  ...
                  render: (e, record) => (
                      <div className="flex gap-2" key={record._id}>
                          <ManagerModel
                              key={record._id}
                              id={record._id}
                              submitHandler={handleContractAwardSubmit}
                              _contract={record}
                          />
                          <Button
                              title="Delete"
                        ...
                        <div className="grid md:grid-cols-2 lg:grid-cols-3 md:gap-3">
                            ...
                            <div className="form-group mb-6">
                                ...
                                <input
                                    ...
                                    defaultValue={_contract?.org_name || ''}
                                />
                            </div>
                            <div className="form-group mb-6">
                                <label className="font-bold">Organisation Address</label>
                                <span className="text-red-600 md:ml-4">
                                    {errors?.org_address?.message}
                                </span>
                                <input
                                    type="text"
                                    className={inputClass}
                                    ...
                                    aria-describedby="org_address"
                                    placeholder="org_address"
                                    defaultValue={_contract?.org_address || ''}
                                />
                            </div>
                            <div className="form-group mb-6">
                                ...
                                <input
                                    ...
                                    defaultValue={_contract?.telephone_no || ''}
                                />
                            </div>
                            <div className="form-group mb-6">
                                ...
                                <input
                                    ...
                                    defaultValue={_contract?.fax_number || ''}
                                />
                            </div>
                            <div className="form-group mb-6">
                            ...
                            <div className="form-group mb-6">
                                ...
                                <input
                                    ...
                                    defaultValue={_contract?.contact_person || ''}
                                />
                            </div>
                        </div>
                        <div className="grid md:grid-cols-2 lg:grid-cols-3 md:gap-3">
                            <div className="form-group mb-6">
                                ...
                                <input
                                    ...
                                    defaultValue={_contract?.big_ref_no || ''}
                                />
                            </div>
                            <div className="form-group mb-6">
                                ...
                                <input
                                    ...
                                    aria-describedby="document_no"
                                    placeholder="document_no"
                                    defaultValue={_contract?.document_no || ''}
                                />
                            </div>
                            <div className="form-group mb-6">
                                <label className="font-bold">Bidding Type</label>
                                <span className="text-red-600 md:ml-4">
                                    {errors?.bidding_type?.message}
                                </span>
                                <input
                                    type="text"
                                    className={inputClass}
                                    ...
                                    aria-describedby="bidding_type"
                                    placeholder="bidding_type"
                                    defaultValue={_contract?.bidding_type || ''}
                                />
                            </div>
                            <div className="form-group mb-6">
                                ...
                                <input
                                    ...
                                    aria-describedby="project_location"
                                    placeholder="project_location"
                                    defaultValue={_contract?.project_location || ''}
                                />
                            </div>
                            <div className="form-group mb-6">
                                ...
                                <input
                                    ...
                                    aria-describedby="contractor_details"
                                    placeholder="contractor_details"
                                    defaultValue={_contract?.contractor_details || ''}
                                />
                            </div>
                            <div className="form-group mb-6">
                                ...
                                <input
                                    ...
                                    aria-describedby="tender_notice_no"
                                    placeholder="tender_notice_no"
                                    defaultValue={_contract?.tender_notice_no || ''}
                                />
                            </div>
                        </div>
                        <div className="grid md:grid-cols-2 lg:grid-cols-3 md:gap-3">
                            <div className="form-group mb-6">
                                ...
                                <input
                                    ...
                                    defaultValue={_contract?.description || ''}
                                />
                            </div>
                            <div className="form-group mb-6">
                                ...
                                <input
                                    type="date"
                                    className={inputClass}
                                    name="awards_publish_date"
                                    {...register('awards_publish_date')}
                                    aria-describedby="awards_publish_date"
                                    placeholder="awards_publish_date"
                                    defaultValue={
                                        moment(_contract?.awards_publish_date).format(
                                            'YYYY-MM-DD',
                                        ) || ''
                                    }
                                />
