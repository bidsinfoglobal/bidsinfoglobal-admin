import { AlibabaOutlined, ArrowRightOutlined, ContactsOutlined, DatabaseOutlined, DownOutlined, HomeOutlined, ReconciliationOutlined, SecurityScanOutlined, UserAddOutlined, UserOutlined, UserSwitchOutlined } from "@ant-design/icons";
        ...
        pages: [
            {
                ...
                element: <Home />,
                children: [],
                access: [userRoles.SALES, userRoles.CONTENT_DEPARTMENT, userRoles.CUSTOMERS, userRoles.IT_SUPPORT],
                isSideBar: true
            },
            {
                key: '3',
